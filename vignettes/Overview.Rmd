...
```{r echo=FALSE, message=FALSE}
download.file("https://raw.githubusercontent.com/AndersenLab/COPASutils-data/master/plateData1.txt", "plateData1.txt", method="curl")
download.file("https://raw.githubusercontent.com/AndersenLab/COPASutils-data/master/BioSorter.txt", "BioSorter.txt", method="curl")
```
